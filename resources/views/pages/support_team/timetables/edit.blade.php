...
@section('page_title', 'Modifier l\'enregistrement de l\'emploi du temps')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Modifier l'enregistrement de l'emploi du temps</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="col-md-8">
                <form class="ajax-update" method="post" action="{{ route('ttr.update', $ttr->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $ttr->name }}" required type="text" class="form-control" placeholder="Nom de l'emploi du temps">
                        </div>
                    </div>
    ...
    {{-- Fin de la modification de l'emploi du temps --}}
@endsection
