<div class="tab-pane fade" id="edit-subs">
    {{-- Si des emplois du temps existent --}}
    @if($tts->count())
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold">{{ ($tt->exam_date ? 'Examen ('.date('D\, d/m/Y', strtotime($tt->exam_date)).')' : $tt->day) }} {{ '('.$tt->time_slot->full.')' .' - '.$tt->subject->name }}</h6>
                                ...
                                <div class="col-md-12">
                                    <form  method="post" action="{{ route('tt.update', $tt->id) }}">
                                        ...
                                        @if($ttr->exam_id)
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label font-weight-semibold">Date
                                                    de l'examen <span class="text-danger">*</span></label>
                                                <div class="col-lg-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <select data-placeholder="Sélectionner une heure..." required class="select form-control" name="ts_id" id="ts_id">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">Soumettre le formulaire <i class="icon-paperplane ml-2"></i>
                                            </button>
                                        </div>
                                    </form>
                                </div>
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">Il n'y a aucun enregistrement à afficher. Ajoutez des matières à l'emploi du temps et rafraîchissez la page.
        </div>
    @endif
</div>
