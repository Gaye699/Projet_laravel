...
@section('page_title', 'Information sur les étudiants - '.$my_class->name)
@section('content')
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ route('students.show', Qs::hash($sr->id)) }}" class="dropdown-item"><i class="icon-eye"></i> Voir les infos</a>
                                                    @if(Qs::userIsTeamSA())
                                                    ...
                                                    @endif
                                                    <a href="#" class="dropdown-item"><i class="icon-check"></i> Relevé de notes</a>
