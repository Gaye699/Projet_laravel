<div>
    ...
    <div style="float: left">
        <br>
        <strong style="text-decoration: underline;">CLÉ</strong> <br>
        <span>5 - Excellent</span> <br>
        <span>4 - Très bon</span> <br>
        <span>3 - Bon</span> <br>
        <span>2 - Moyen</span> <br>
        <span>1 - Faible</span> <br>
    </div>

    <table align="left" style="width:40%; border-collapse:collapse; border: 1px solid #000; margin:10px 20px;" border="1">
        <thead>
        <tr>
            <td><strong>TRAITS AFFECTIFS</strong></td>
    ...
    <table align="left" style="width:35%; border-collapse:collapse;border: 1px solid #000;  margin: 10px 20px;" border="1">
        <thead>
        <tr>
            <td><strong>PSYCHOMOTEUR</strong></td>
            <td><strong>NOTATION</strong></td>
        </tr>
        </thead>
        <tbody>
